...
import 'package:industrialvisit/usercreatedpackagesdes.dart';

import 'api.dart';

class usercreatedpackages extends StatefulWidget {

  const usercreatedpackages({Key? key}) : super(key: key);

  @override
  State<usercreatedpackages> createState() => _usercreatedpackagesState();
}

class _usercreatedpackagesState extends State<usercreatedpackages> {
  List _loaddata=[];
  late int id;
  _fetchData() async {
                    ...
                    ListView.builder(
                        ...
                        itemBuilder: (context, index)
                        {
                          ...
                          return GestureDetector(
                            onTap: () => {
                              Navigator.push(context, MaterialPageRoute(builder: (context) =>userpackagedescription(id:id)))
                            },
                            child: Container(
